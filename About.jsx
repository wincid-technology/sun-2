                ...
                <div class="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
                    <div class="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
                        <div class="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                            <h2 class="text-gray-900 kanit-semibold-italic text-4xl font-bold font-manrope leading-normal lg:text-start text-center">Who We Are</h2>
                    ...
                    <img class="lg:mx-0 mx-auto h-full rounded-tl-[100px] rounded-br-[100px] object-cover" src="/img/recycleCard.jpg" alt="about Us image" />
                </div>
            </div>
        </section>
